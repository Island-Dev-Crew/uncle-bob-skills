...
This island owns one pass: **inventory the error paths, interrogate each one, recount.** Quotes reach it only through the [concept ledger](../../docs/01-CONCEPT-LEDGER.md).
